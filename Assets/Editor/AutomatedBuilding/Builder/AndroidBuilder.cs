...
using System.IO;
using LionStudios.Editor.AutomatedBuilding;
using UnityEditor;
...
public class AndroidBuilder : Builder
{
    ...
    {
        _androidBuildSettings = AssetDatabase.LoadAssetAtPath<AndroidBuildSettings>
            ("Assets/Editor/AutomatedBuilding/Settings/AndroidBuildSettings.asset");
    }
